...
void characterMap_getCharacter(characterMap_t* characterMap, size_t index, char *character); //character must be an array of 5 bytes. This array will be populated with a null terminated UTF-8 encoded character.
