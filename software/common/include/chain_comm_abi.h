...
#define SEQUENTIAL_WRITE_PASSTHROUGH_PERIOD_MS (SEQUENTIAL_WRITE_TRIGGER_DELAY_MS - SEQUENTIAL_WRITE_TRIGGER_DELAY_EXTRA_MS)
...
typedef enum __attribute__((__packed__)){
    MODULE_PROPERTY(GENERATE_PROPERTY_ENUM)
}moduleProperty_t;

static const char* propertyNames[] = {
    MODULE_PROPERTY(GENERATE_PROPERTY_NAME)
};

static const uint8_t propertySizes[] = {
    MODULE_PROPERTY(GENERATE_PROPERTY_SIZE)
};
