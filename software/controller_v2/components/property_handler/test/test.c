...
TEST_CASE("Test to_binary handler", "[properties][qemu]")
{
    ...
    module_t module = {
        ...
        .character_set =
            {
                .size          = 48,
                .character_set = (uint8_t *)((uint32_t *) {
                    (uint32_t)' ', (uint32_t)'A', (uint32_t)'B', (uint32_t)'C', (uint32_t)'D', (uint32_t)'E',
                    (uint32_t)'F', (uint32_t)'G', (uint32_t)'H', (uint32_t)'I', (uint32_t)'J', (uint32_t)'K',
                    (uint32_t)'L', (uint32_t)'M', (uint32_t)'N', (uint32_t)'O', (uint32_t)'P', (uint32_t)'Q',
                    (uint32_t)'R', (uint32_t)'S', (uint32_t)'T', (uint32_t)'U', (uint32_t)'V', (uint32_t)'W',
                    (uint32_t)'X', (uint32_t)'Y', (uint32_t)'Z', (uint32_t)'0', (uint32_t)'1', (uint32_t)'2',
                    (uint32_t)'3', (uint32_t)'4', (uint32_t)'5', (uint32_t)'6', (uint32_t)'7', (uint32_t)'8',
                    (uint32_t)'9', SYMBOL_€,      (uint32_t)'$', (uint32_t)'!', (uint32_t)'?', (uint32_t)'.',
