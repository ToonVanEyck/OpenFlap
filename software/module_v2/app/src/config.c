...
{
    // config->ir_limits[0] = (ir_sens_threshold_t){.ir_low = 200, .ir_high = 200};
    // config->ir_limits[1] = (ir_sens_threshold_t){.ir_low = 200, .ir_high = 200};
    // config->ir_limits[2] = (ir_sens_threshold_t){.ir_low = 200, .ir_high = 200};
    // config->ir_limits[3] = (ir_sens_threshold_t){.ir_low = 200, .ir_high = 200};
    // config->ir_limits[4] = (ir_sens_threshold_t){.ir_low = 200, .ir_high = 200};
    // config->ir_limits[5] = (ir_sens_threshold_t){.ir_low = 200, .ir_high = 200};
